...
import '../globals.css'
import { rootMetadataFr, rootViewport } from '@/lib/root-metadata'
...
// FR root layout — see (en)/layout.tsx for why per-locale ROOT layouts
// (static <html lang>, no shared app/layout.tsx with headers()) are used.
export const metadata = rootMetadataFr
